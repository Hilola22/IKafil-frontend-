          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm mt-1">Beige, 256 GB, Wi-Fi+Cellular</p>
              </div>
            </div>

            <div className="text-right">
              <p className="text-xl font-semibold">
                {item.price.toLocaleString()} <span className="text-sm">сум</span>
              </p>
              <button className="mt-2 text-red-500 hover:text-red-600">🗑️</button>
            </div>
          </div>
        ))}
      </div>
